...
namespace TicTacToe
{
    class Program
    {
        //Declaring a global array to hold the number placement of the objects.
        ...
        //Create a global variable and initalize it to 0. Needed to keep launch of turns.
        static int turns = 0;
        ...
        static void Main(string[] args)
        {
            ...
            //Determine which players turn exist.
            do
            {
                ...
                #region
                // Test if field is already selected.
                do
                {
        ...
        //Behavior to reset the field each time the game has finished.
        public static void resetField()
        {
            //Local array to create an initial numberPlacement.
        ...
        //This is the playing field where the end user can interact with.
